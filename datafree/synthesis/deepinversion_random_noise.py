...
class DeepInvSynthesizer_Random_Noise_Init(BaseSynthesis):
    def __init__(self, teacher, student, num_classes, img_size, 
        ...
        super(DeepInvSynthesizer_Random_Noise_Init, self).__init__(teacher, student)
    ...
    def synthesize(self, targets=None, images=None, batch_idx=0):
        ...
        if not os.path.exists('./loss/iter_500/loss_deepinv_random_noise/total_loss/'):
           os.makedirs('./loss/iter_500/loss_deepinv_random_noise/total_loss/')

        if not os.path.exists('./loss/iter_500/loss_deepinv_random_noise/loss_l2/'):
           os.makedirs('./loss/iter_500/loss_deepinv_random_noise/loss_l2/')

        if not os.path.exists('./loss/iter_500/loss_deepinv_random_noise/loss_tv/'):
           os.makedirs('./loss/iter_500/loss_deepinv_random_noise/loss_tv/')

        if not os.path.exists('./loss/iter_500/loss_deepinv_random_noise/loss_adv/'):
           os.makedirs('./loss/iter_500/loss_deepinv_random_noise/loss_adv/')

        if not os.path.exists('./loss/iter_500/loss_deepinv_random_noise/loss_oh/'):
           os.makedirs('./loss/iter_500/loss_deepinv_random_noise/loss_oh/')

        if not os.path.exists('./loss/iter_500/loss_deepinv_random_noise/loss_bn/'):
           os.makedirs('./loss/iter_500/loss_deepinv_random_noise/loss_bn/')

        torch.save(total_loss_iter, './loss/iter_500/loss_deepinv_random_noise/total_loss/loss_total_deepinv_random_noise_batch_idx_'+str(batch_idx)+'.pth')
        torch.save(loss_l2_iter, './loss/iter_500/loss_deepinv_random_noise/loss_l2/loss_l2_deepinv_random_noise_batch_idx_'+str(batch_idx)+'.pth')
        torch.save(loss_tv_iter, './loss/iter_500/loss_deepinv_random_noise/loss_tv/loss_tv_deepinv_random_noise_batch_idx_'+str(batch_idx)+'.pth')
        torch.save(loss_adv_iter, './loss/iter_500/loss_deepinv_random_noise/loss_adv/loss_adv_deepinv_random_noise_batch_idx_'+str(batch_idx)+'.pth')
        torch.save(loss_oh_iter, './loss/iter_500/loss_deepinv_random_noise/loss_oh/loss_oh_deepinv_random_noise_batch_idx_'+str(batch_idx)+'.pth')
        torch.save(loss_bn_iter, './loss/iter_500/loss_deepinv_random_noise/loss_bn/loss_bn_deepinv_random_noise_batch_idx_'+str(batch_idx)+'.pth')
