...
class DeepInvSyntheiszer_Public_img_init_constraint(BaseSynthesis):
    def __init__(self, teacher, student, num_classes, img_size, 
        ...
        super(DeepInvSyntheiszer_Public_img_init_constraint, self).__init__(teacher, student)
    ...
    def synthesize(self, targets=None, images=None):
        ...
        for it in range(self.iterations):
            ...
            loss = loss + loss_privacy_constraint * self.privacy_constraint
